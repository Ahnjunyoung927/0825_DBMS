 ...
 * 
 * -- 회원번호, 사원번호, 게시글번호, 예약번호, 주문번호 등등 채번 할 때 사용함
 * 
 * 1. 시퀀스 객체 생성 구문
 * 
 * [ 표현법 ]
 ...
 *                 (시퀀스명.CURRVAL + INCREMENT BY값(기본값1))
 * 
...
-- LAST NUMBER : 지금 NEXTVAL하면 나오는 값

-- 수정 : ALTER --> START WITH는 변경 불가능, 반드시 바꾸겠다면 DROP하고 다시 CREATE
-- 삭제 : DROP

CREATE SEQUENCE SEQ_EID
 START WITH 224;

-- 사원을 추가해야할 때마다 수항하는 INSERT
INSERT
  INTO
       EMPLOYEE
       (
